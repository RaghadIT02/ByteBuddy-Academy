...
function storeData(name) {
    // Remove 'Ali' and 'Noura' if they exist in local storage
    localStorage.removeItem('childNames'); // Remove the entire childNames key
    localStorage.removeItem('parentChildren'); // Remove the parentChildren key
